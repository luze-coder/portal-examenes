...
export class ExamenService {
  ...
  public listarExamenesPorUsuario(usuarioId: any) {
    return this.http.get(`${baserUrl}/examen/usuario/${usuarioId}`);
  }

  // examen.service.ts
  public obtenerPublicadosYRestringidosDeUnaCategoria(catId: number) {
    return this.http.get(`${baserUrl}/examen/publicados-restringidos/categoria/${catId}`);
  }
